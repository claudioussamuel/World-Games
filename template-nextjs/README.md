# Phaser Next.js Template with Privy Authentication

This is a Phaser 3 project template that uses the Next.js framework with Privy authentication integration. It includes a bridge for React to Phaser game communication, hot-reloading for quick development workflow, user authentication, and scripts to generate production-ready builds.
...
- **Phaser 3 Game Engine** - Full-featured 2D game development
- **Next.js Framework** - React-based web application framework
- **Privy Authentication** - Web3 and traditional authentication
...
This template includes Privy authentication integration. To set up authentication:

1. **Install dependencies**: `npm install`
2. **Get Privy App ID**: Visit [Privy Dashboard](https://dashboard.privy.io/)
3. **Set environment variables**: Copy `env.example` to `.env.local` and add your App ID
4. **Configure login methods** in the Privy Dashboard

See [PRIVY_SETUP_GUIDE.md](./PRIVY_SETUP_GUIDE.md) for detailed setup instructions.
